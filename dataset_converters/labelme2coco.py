...
IMG_EXTENSION = ('.jpg', '.png', '.jpeg', '.JPG', '.PNG')
...
def to_coco(args, label_files, train):
    ...
    for image_id, filename in enumerate(label_files):
        ...
        if train:
            out_img_file = osp.join(args.output_dir, "train2017", label_file.imagePath)
        else:
            out_img_file = osp.join(args.output_dir, "val2017", label_file.imagePath)
...
def main():
    ...
    parser.add_argument("--input_dir", default='../Dataset/detection/sales/data', help="input annotated directory")
    parser.add_argument("--output_dir", default='../Dataset/detection/sales/dataset', help="output dataset directory")
    parser.add_argument("--labels", default='../Dataset/detection/sales/label_file.txt', help="labels file")
    parser.add_argument("--noviz", help="no visualization", action="store_false")
    ...
    # 获取目录下所有的.jpg文件列表
    feature_files = [i for i in os.listdir(args.input_dir) if i.endswith(IMG_EXTENSION)]
